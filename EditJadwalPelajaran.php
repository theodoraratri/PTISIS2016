...
<html>
    ...
    <body>
        <!-- ####################################################################################################### -->
          <!-- untuk menginputkan data kode jadwal,Nama Kelas, Hari,Jam,NIP,Mata Pelajaran yang di edit,
         menampilkan konfirmasi OK/Batal, menampilkan kode jadwal,Nama kelas,Hari,Jam,NIP,mata pelajaran dari database -->
            ...
            <div id="featured_slide">
                <div id="featured_wrap">
                    <div class="topbox">
                        ...
                        <form action="MasukDataJadwalPelajaran">
                            <table> 
                                <tr>
                                    <td><label>Kode Jadwal&nbsp;&nbsp;</label></td>
                                    <td><input name="" type="text" class="textbox"></td>
                                </tr>
                                <tr>
