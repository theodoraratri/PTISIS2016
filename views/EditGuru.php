                ...
                <ul>
                    ...
                    <li><?php echo anchor('DataKelas/index/', 'Kelola Data Kelas'); ?>
                        <ul>
                            ...
                            <li><?php echo anchor('DataKelas/tampilhapus_kelas/', 'Menghapus Data Kelasu'); ?></li>
                    ...
                    <form method="post" action="<?= base_url() ?>index.php/DataGuru/updateDataGuru">
                        <table> 
                            <tr>
                                ...
                                <td><input value="<?php echo $nip; ?>" name="nipe" type="text" class="textbox" readonly></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input value="<?php echo $password; ?>" name="passguru" type="text" class="textbox" required=""></td>
                            </tr>
                        </table>
                        <input type="submit" value="Simpan">
                        <input type="submit" value="Batal" <?php echo anchor('DataGuru/tampiledit_guru/', ' '); ?>
                    </form>
                </div>
            </div>
        </div>
