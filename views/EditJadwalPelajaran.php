            ...
            <div id="featured_slide">
                <div id="featured_wrap">
                    <div class="topbox">
                        ...
                        <form method="post" action="<?= base_url(); ?>index.php/DataJadwalPelajaran/EditJadwal">
                            <table> 
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input value="<?php echo $hari; ?>" name="hr" type="text" class="textbox"></td>
                                </tr>
                                <tr>
