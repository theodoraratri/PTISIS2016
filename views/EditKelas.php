...
<html>
    ...
    <body>
        ...
        <div class="wrapper col3">
            ...
            <form method="post" action="<?= base_url(); ?>index.php/DataKelas/updateDataKelas">
                <table> 
                    <tr>
                        <td><label>ID Kelas &nbsp;&nbsp;</label></td>
                        <td><input value="<?php echo $id_kelas; ?>" name="id" type="text" class="textbox" readonly=""></td>
                    </tr>
                    <tr>
