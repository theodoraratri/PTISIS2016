...
<html>
    ...
    <body>
        <!-- ####################################################################################################### -->
        <!-- Menampilkan NIP,kode jadwal,hari,jam,nama kelas,mata pelajaran sebelum di hapus ,menekan tmbol hapus,
        Konfirmasi OK/Batal,Menampilkan NIP,kode jadwal,hari,jam,nama kelas,mata pelajaran setelah di hapus-->
            ...
            <div id="featured_slide">
                <div id="featured_wrap">
                    <h3>HAPUS DATA JADWAL PELAJARAN</h3>
                     <form method="post" action="<?= base_url() ?>index.php/DataJadwalPelajaran/deleteJadwal">
                            ...
                            if (isset($ja)) {
                                foreach ($ja->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo anchor('DataJadwalPelajaran/deleteJadwal/' . $row->kode_jadwal, 'Hapus'); ?></td>
