...
<html>
    ...
    <body>
        ...
        <div class="wrapper col3">
            ...
            <form method="post" action="<?= base_url() ?>index.php/DataKelas/deleteDataKelas">
                <h1 align="center">Tabel Data Kelas</h1>
                <table width="80%" border="1" cellpading="2">
                    ...
                    <?php
                    if (isset($dkelas)) {
                        foreach ($dkelas as $row) {
                            ?>
                            <tr>
                                <td><?php echo $row->id_kelas; ?></td>
                                <td><?php echo $row->nama_kelas; ?></td>
                                <td><?php echo $row->nip; ?></td>
                                <td><?php echo anchor('DataKelas/deleteDataKelas/' . $row->id_kelas, 'Hapus'); ?></td>
                            </tr>
                            <?php
                        }
                    }
