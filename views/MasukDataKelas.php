...
<html>
    ...
    <body>
        ...
        <div class="wrapper col3">
            ...
            <form method="post" action="<?= base_url() ?>index.php/DataKelas/insertDataKelas">
                <table> 
                    <tr>
                        <td><label>ID Kelas&nbsp;&nbsp;</label></td>
                        <td><input name="id" type="text" class="textbox"></td>
                    </tr>
                    <tr>
