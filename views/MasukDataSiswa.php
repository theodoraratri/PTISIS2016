                         ...
                         <form method="post" action="<?= base_url() ?>index.php/DataSiswa/insertDataSiswa">
                            <table> 
                                <tr>
                                    ...
                                    <td><input name="nomorinduk" type="text" class="textbox"></td>
                                </tr>
                                <tr>
                                    <td><label>Nama Siswa&nbsp;&nbsp;</label></td>
                                    <td><input name="namasiswa" type="text" class="textbox"></td>
                                </tr>
                                <tr>
                                    <td><label>Angkatan &nbsp;&nbsp;</label></td>
                                    <td><input name="angkatan" type="text" class="textbox"></td>
                                </tr>
                                <tr>
                                    <td><label>Id Kelas &nbsp;&nbsp;</label></td>
                                    <td><input name="idkelas" type="text" class="textbox"></td>
                                </tr>
                            </table>
